...
Today Latin R just got started. It was really impressive to see how many people actually uses R. I have to say the popularity of Python in Data Sciences has always been something that worries me tons, but today I was able to see a lot of other Subjects where people actually use R. Probably I was one of the few people working in Data Science there.
...
[Erin Ledell](https://twitter.com/ledell) conducted this tutorial that was more like a demonstration of the capabilities of H2o. I have to say I have heard about H2o in Matt Danchos' tutorials but I never got impressed because I´m a super fan of Tidymodels and H2o is not there yet.
 ...
 * Clasification or Regression Problems are detected depending on the data type of the Target Variable. (Not a huge issue but I like to have control over that).
...
Don´t get me wrong. H2o is awesome and a great starting point for people recently learning about Machine Learning and for experienced Machine Learning people that want fast algorithms.

It also offers AutoMl and stacked ensembles that with little work can help to achieve excellent performance.

Another think I liked, more like a sidenote, was that running this into Rstudio cloud was super smooth. I just had to install the h2o package as any other R package and that was it. The internet was not the best and even so everything ran super fast.
...
The content was not a big deal, he showed the necessary steps to create a package that is actually easy than expected. But the way in whih he directed the class:
 ...
 * Makes us meet our neighbours to work peer to peer.
