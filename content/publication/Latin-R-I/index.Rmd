...
Finally Erin mentioned that Max Kuhn and his team is working in integrating H2o with the tidymodels ecosystem. If that happens H2o will start liking even more. 
...
The content was not a big deal, he showed the necessary steps to create a package that is actually easy than expected. But the way he directed the class:
...
* I don´t fully prepared to create a huge package yet, but I´m not afraid anymore.
